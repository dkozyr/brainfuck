...
op_close_short:     jnz     $-1000000
op_set_value:       mov     byte [RBX], 0
op_eos:             mov     RDX, RDI
                    sub     RDX, output                 ; length
...
OP_CLOSE_SHORT_SIZE equ     (op_set_value - op_close_short)
...
QWORD_SIZE          equ     8
OPERAND_INFO_SIZE   equ     2 * QWORD_SIZE
...
_process_symbol:    mov     AL, [RSI]
                    ...
                    process_script_open_minus_close ID_SET_VALUE, OP_SET_VALUE_SIZE
                    ...
                    cmp     byte [RDI - 1], ID_ADD
                    jz      _good_close_short
                    cmp     byte [RDI - 1], ID_SUB
                    jz      _good_close_short
                    jmp     _test_close

_good_close_short:  mov     AL, ID_CLOSE_SHORT
                    add     RDX, OP_CLOSE_SHORT_SIZE
                    jmp     _good_symbol

_test_close:        process_script_symbol ']', ID_CLOSE,   OP_CLOSE_SIZE
